...
export default function TeacherLayout({ children }) {
  ...
  const NavItem = ({ href, icon: Icon, label }) => (
    <Link
      ...
      className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-100 hover:text-blue-900 transition"
    >
      <Icon size={18} />
      {label}
    </Link>
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="lg:hidden flex items-center gap-3 bg-white border-b p-4 shrink-0">
          ...
          <span className="font-semibold text-gray-800">Teacher Panel</span>
        </header>
